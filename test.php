...
<body>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="start_date" id="PickUpDateModal" required readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="end_date" id="ReturnDateModal" required readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="drivers_license_image" class="form-label">Upload Driver's License:</label>
                                <input type="file" class="form-control" name="drivers_license_image" id="drivers_license_image" accept="image/*" required>
                                <small class="form-text text-muted">Accepted formats: .jpg, .jpeg, .png, .pdf</small>
                            </div>
                            <div class="mb-3">
                                <label for="insurance_card_image" class="form-label">Upload Insurance Card:</label>
                                <input type="file" class="form-control" name="insurance_card_image" id="insurance_card_image" accept="image/*" required>
                                <small class="form-text text-muted">Accepted formats: .jpg, .jpeg, .png, .pdf</small>
                            </div>
                        </div>
    ...
    <script>
        // Script to handle the calendar and date selection logic as before
