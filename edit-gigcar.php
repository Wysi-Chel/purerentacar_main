    ...
    $sql = "SELECT * FROM gigcars WHERE id = $car_id";
    ...
    <body class="light-scheme">
        <div class="container">
            <form action="process_edit_gigcar.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="category" name="category" required>
                        ...
                        $cat_sql = "SELECT DISTINCT category FROM gigcars WHERE category IS NOT NULL AND TRIM(category) <> ''";
                ...
                <div class="mb-3">
                    ...
                    <?php if (!empty($car['gigcar_dispimage'])): ?>
                        <img src="<?php echo $car['gigcar_dispimage']; ?>" alt="Current Display Image" class="current-img">
                    <?php else: ?>
                        <p>No official image uploaded.</p>
                    <?php endif; ?>
                    <input type="file" class="form-control" name="gigcar_dispimage">
